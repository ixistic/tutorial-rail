...
class RentalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rental" do
    assert_difference('Rental.count') do
      post rentals_url, params: { rental: { book: @rental.book, rental_date: @rental.rental_date, user: @rental.user } }
    end
  ...
  test "should update rental" do
    patch rental_url(@rental), params: { rental: { book: @rental.book, rental_date: @rental.rental_date, user: @rental.user } }
